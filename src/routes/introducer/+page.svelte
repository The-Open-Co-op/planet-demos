...
<div class="space-y-10">
	...
	<section class="grid gap-4 sm:grid-cols-2">
		<Card>
			<CardHeader>
				...
				<CardDescription>US-01 — US-03: search contacts, write context, preview, send.</CardDescription>
			</CardHeader>
			<CardContent>
	...
	<section class="border-border bg-muted/30 rounded-xl border p-6">
		...
		<ol class="text-muted-foreground list-decimal space-y-2 pl-5 text-sm">
			<li>Stay as <strong>Alex</strong>, open Compose, pick Blake and Casey, write a message, preview, send.</li>
			<li>
			...
			<li>Trigger the ripple demo below to see a distinct ripple alert for the seed introducer (switch to Alex in Alerts).</li>
		</ol>
		<p class="text-muted-foreground mt-4 flex items-start gap-2 text-sm">
		...
		<div class="mt-4 flex flex-wrap items-center gap-2">
			...
			<span class="text-muted-foreground text-xs">Switch to Alex in Alerts to see the ripple notification.</span>
		</div>
	</section>
</div>
